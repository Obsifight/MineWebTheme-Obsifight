          ...
          <?php foreach ($news['Comment'] as $k => $v) { ?>
            <div class="media" id="comment-<?= $v['id'] ?>">
              <span class="user-avatar">
                <img class="pull-left media-object" src="<?= $this->Html->url(array('controller' => 'ObsiAPI', 'action' => 'getHeadSkin', 'plugin' => 'obsi', $v['author'], '64')) ?>" width="64" height="64" alt="">
              </span>
    ...
    function addcomment(data) {
      ...
      comment += '<div class="media"';
        comment +='<span class="user-avatar">';
          comment +='<img class="pull-left media-object" src="<?= $this->Html->url(array('controller' => 'ObsiAPI', 'action' => 'getHeadSkin', 'plugin' => 'obsi', $user['pseudo'], '64')) ?>" width="64" height="64" alt="">';
        comment += '</span>';
